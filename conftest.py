...
ORDERS = [{"by_button": BasePageLocators.BUTTON_MIDDLE_ORDER,
           "firstname": 'Яша',
           "lastname": 'Лава',
           "address": 'Москва, ул. Кеков, 1337 - 7331',
           "phone": '+79260007654',
           "subway_station": 'Боровицкая ',
           "date": (datetime.now() + timedelta(days=7)).strftime("%d.%m.%Y"),
           "duration": 7,
           "color": 'grey',
           "comment": 'Подъезд со стороны реки за мусоркой'
           },
          {"by_button": BasePageLocators.BUTTON_HEADER_ORDER,
           "firstname": 'Павел',
           "lastname": 'Смирнов',
           "address": 'Москва, пер. Папичкина, 121 - 997',
           "phone": '+79014321234',
           "subway_station": 'Аэропорт ',
